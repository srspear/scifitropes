...
class newwavescifibot(scrapy.Spider):
    name = 'newwavescifibot'
    start_urls = ['https://tvtropes.org/pmwiki/pmwiki.php/Main/NewWaveScienceFiction']
    custom_settings = {
        'DOWNLOAD_DELAY': 2,
        'ROBOTSTXT_OBEY': True,
        'FEEDS': {
            'newwavescifi.csv': {'format': 'csv', 'overwrite': False},
        },
    }
