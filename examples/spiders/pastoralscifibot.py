...
class pastoralscifibot(scrapy.Spider):
    name = 'pastoralscifibot'
    start_urls = ['https://tvtropes.org/pmwiki/pmwiki.php/Main/PastoralScienceFiction']
    custom_settings = {
        'DOWNLOAD_DELAY': 2,
        'ROBOTSTXT_OBEY': True,
        'FEEDS': {
            'pastoralscifi.csv': {'format': 'csv', 'overwrite': False},
        },
    }
