...
class magiccomputerbot(scrapy.Spider):
    name = 'magiccomputerbot'
    start_urls = ['https://tvtropes.org/pmwiki/pmwiki.php/Main/MagicalComputer']
    custom_settings = {
        'DOWNLOAD_DELAY': 2,
        'ROBOTSTXT_OBEY': True,
        'FEEDS': {
            'magiccomputer.csv': {'format': 'csv', 'overwrite': False},
        },
    }
