...
class transhumansinspacebot(scrapy.Spider):
    name = 'transhumansinspacebot'
    start_urls = ['https://tvtropes.org/pmwiki/pmwiki.php/Main/TranshumansInSpace']
    custom_settings = {
        'DOWNLOAD_DELAY': 2,
        'ROBOTSTXT_OBEY': True,
        'FEEDS': {
            'transhumansinspace.csv': {'format': 'csv', 'overwrite': False},
        },
    }
