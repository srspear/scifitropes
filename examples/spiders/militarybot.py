...
class militarybot(scrapy.Spider):
    name = 'militarybot'
    start_urls = ['https://tvtropes.org/pmwiki/pmwiki.php/Main/MilitaryScienceFiction']
    custom_settings = {
        'DOWNLOAD_DELAY': 2,
        'ROBOTSTXT_OBEY': True,
        'FEEDS': {
            'militaryscifi.csv': {'format': 'csv', 'overwrite': False},
        },
    }
