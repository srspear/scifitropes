...
class videogamestoriesbot(scrapy.Spider):
    name = 'videogamestoriesbot'
    start_urls = ['https://tvtropes.org/pmwiki/pmwiki.php/Main/VideoGameStories']
    custom_settings = {
        'DOWNLOAD_DELAY': 2,
        'ROBOTSTXT_OBEY': True,
        'FEEDS': {
            'videogamestories.csv': {'format': 'csv', 'overwrite': False},
        },
    }
