...
class cyberpunkflavorbot(scrapy.Spider):
    name = 'cyberpunkflavorbot'
    start_urls = ['https://tvtropes.org/pmwiki/pmwiki.php/Main/CyberpunkForFlavor']
    custom_settings = {
        'DOWNLOAD_DELAY': 2,
        'ROBOTSTXT_OBEY': True,
        'FEEDS': {
            'cyberpunkflavor.csv': {'format': 'csv', 'overwrite': False},
        },
    }
