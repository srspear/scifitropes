...
class spacewesternbot(scrapy.Spider):
    name = 'spacewesternbot'
    start_urls = ['https://tvtropes.org/pmwiki/pmwiki.php/Main/SpaceWestern']
    custom_settings = {
        'DOWNLOAD_DELAY': 2,
        'ROBOTSTXT_OBEY': True,
        'FEEDS': {
            'spacewestern.csv': {'format': 'csv', 'overwrite': False},
        },
    }
