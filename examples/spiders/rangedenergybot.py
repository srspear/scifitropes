...
class rangedenergybot(scrapy.Spider):
    name = 'rangedenergybot'
    start_urls = ['https://tvtropes.org/pmwiki/pmwiki.php/Main/RangedEnergyAttackTropes']
    custom_settings = {
        'DOWNLOAD_DELAY': 2,
        'ROBOTSTXT_OBEY': True,
        'FEEDS': {
            'rangedenergyattack.csv': {'format': 'csv', 'overwrite': False},
        },
    }
