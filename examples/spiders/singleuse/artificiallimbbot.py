...
class artificiallimbbot(scrapy.Spider):
    name = 'artificiallimbbot'
    start_urls = ['https://tvtropes.org/pmwiki/pmwiki.php/Main/AutonomousAndArtificialAppendageIndex']
    custom_settings = {
        'DOWNLOAD_DELAY': 2,
        'ROBOTSTXT_OBEY': True,
        'FEEDS': {
            'artificiallimbs.csv': {'format': 'csv', 'overwrite': False},
        },
    }
