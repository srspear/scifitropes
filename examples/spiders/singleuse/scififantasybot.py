...
class scififantasybot(scrapy.Spider):
    name = 'scififantasybot'
    start_urls = ['https://tvtropes.org/pmwiki/pmwiki.php/Main/ScienceFantasy']
    custom_settings = {
        'DOWNLOAD_DELAY': 2,
        'ROBOTSTXT_OBEY': True,
        'FEEDS': {
            'scififantasy.csv': {'format': 'csv', 'overwrite': False},
        },
    }
