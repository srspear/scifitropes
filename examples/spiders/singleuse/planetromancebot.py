...
class planetromancebot(scrapy.Spider):
    name = 'planetromancebot'
    start_urls = ['https://tvtropes.org/pmwiki/pmwiki.php/Main/PlanetaryRomance']
    custom_settings = {
        'DOWNLOAD_DELAY': 2,
        'ROBOTSTXT_OBEY': True,
        'FEEDS': {
            'planetaryromance.csv': {'format': 'csv', 'overwrite': False},
        },
    }
