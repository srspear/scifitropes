...
class identiclonesbot(scrapy.Spider):
    name = 'identiclonesbot'
    start_urls = ['https://tvtropes.org/pmwiki/pmwiki.php/Main/OurClonesAreIdentical']
    custom_settings = {
        'DOWNLOAD_DELAY': 2,
        'ROBOTSTXT_OBEY': True,
        'FEEDS': {
            'identicalclone.csv': {'format': 'csv', 'overwrite': False},
        },
    }
