...
class futuretechbot(scrapy.Spider):
    name = 'futuretechbot'
    start_urls = ['https://tvtropes.org/pmwiki/pmwiki.php/Main/FuturisticTechIndex']
    custom_settings = {
        'DOWNLOAD_DELAY': 2,
        'ROBOTSTXT_OBEY': True,
        'FEEDS': {
            'futuretechtropes.csv': {'format': 'csv', 'overwrite': False},
        },
    }
