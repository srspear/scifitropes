...
class teleportationbot(scrapy.Spider):
    name = 'teleportationbot'
    start_urls = ['https://tvtropes.org/pmwiki/pmwiki.php/Main/TeleportationTropes']
    custom_settings = {
        'DOWNLOAD_DELAY': 2,
        'ROBOTSTXT_OBEY': True,
        'FEEDS': {
            'teleportation.csv': {'format': 'csv', 'overwrite': False},
        },
    }
