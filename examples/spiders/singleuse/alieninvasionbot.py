...
class alieninvasionbot(scrapy.Spider):
    name = 'alieninvasionbot'
    start_urls = ['https://tvtropes.org/pmwiki/pmwiki.php/Main/AlienInvasion']
    custom_settings = {
        'DOWNLOAD_DELAY': 2,
        'ROBOTSTXT_OBEY': True,
        'FEEDS': {
            'alieninvasion.csv': {'format': 'csv', 'overwrite': False},
        },
    }
